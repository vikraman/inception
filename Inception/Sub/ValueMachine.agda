  ...
  mutual
    ...
    comp-wke-lemma (sub {A = A} W₁ W₂) E E' π ϖ ϖ' θ =
      let
        ...
        -- b1-goal :  (csn₁ csn₂ : List (ℕ × ℕ)) (c≤c' : csn₁ ≤ᶜˢⁿ csn₂)
        --           →    proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁
        --             ≤ᴹ proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁
        -- b1-goal csn₁ csn₂ c≤c' = (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁)

        -- b       :  (csn₁ csn₂ : List (ℕ × ℕ)) (c≤c' : csn₁ ≤ᶜˢⁿ csn₂)
        --           →    proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁
        --             ≤ᴹ proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁
        ...
        bx    : (csn₁ : List (ℕ × ℕ)) →
        comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ')
        ≡
        comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ)
        -}
        ...
        --h1 csn₁ csn₂ = subst (λ x → x) (dx' csn₁ csn₂) (h0 {csn₁} {csn₂})

        -- --f0 csn₁ csn₂ c≤c' = subst (λ x → x) (dx' csn₁ csn₂) (e0 {csn₁} {csn₂} c≤c')
        ...
        -- Goal:    incr (suc ⟪ proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₁ csn₁ ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁)
        --          ≤ᴹ incr (suc ⟪ proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₁ csn₂ ⟫)        (proj₂ (comp-mono-metric W₁
        -- ((`V ,
        --   proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ,
        --   (λ _ →
        --      m-V 0
        --      (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ +
        --       csn-to-nat₀
        --       ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂))
        --   , (λ c≤c'' → ≤-V z≤n ≤-refl))
        --  ∷ E')
        -- (wkn-cong ϖ'))
        --.proj₁ csn₂)
        ...
        -- equ csn₁ csn₂ c≤c' =
        --      let
        --         fx1 : incr (suc ⟪ proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₁ csn₁ ⟫)  (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁) ≤ᴹ incr (suc ⟪        proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₁ csn₂ ⟫)        (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ)) .proj₁ csn₂)
        ...
        --         fx2 : incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₁) ≤ᴹ incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ))       csn₂ ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn₂)
        --         fx2 = (subst₂ (λ x y → {csn₁ csn₂ : List (ℕ × ℕ)} (c≤c' : csn₁ ≤ᶜˢⁿ csn₂) → x csn₁ ≤ᴹ y csn₂) h0' h0' c1) c≤c'
        --      in
        --      ≤ᴹ-uniq
        --        fx1
        --        fx2
        -- equ' csn₁ csn₂ = extensionality (equ csn₁ csn₂)
        -- equ'' csn₁ = extensionality' (equ' csn₁)
        -- equ''' = extensionality' equ''
        -- eqx = cong (λ x {csn₁} {csn₂} c≤c' → x csn₁ csn₂ c≤c') equ'''
        ...
        --eqz : (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ) (wkn-cong ϖ) (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) c≤c'))) ≡ (subst₂ (λ x y → {csn₁ csn₂ : List (ℕ × ℕ)} (c≤c' : csn₁ ≤ᶜˢⁿ csn₂) → x csn₁ ≤ᴹ y csn₂) h0' h0' c1)
        ...
        {-
                ...
                (λ {csn₁} {csn₂} c≤c' → subst₂ (λ x y → {csn₁ = csn₃ : List (ℕ × ℕ)} {csn₂ = csn₄ : List (ℕ × ℕ)} (c≤c'' : csn₃ ≤ᶜˢⁿ csn₄) → x csn₃ ≤ᴹ y csn₄) h0' h0' c1 c≤c'))

                (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ)))  c≤c'))))
                subst₂ (λ x y → {csn₁ csn₂ : List (ℕ × ℕ)} (c≤c' : csn₁ ≤ᶜˢⁿ csn₂) → x csn₁ ≤ᴹ y csn₂) h0' h0' c1)
        -}

        h1 = dcong₂ {A = (List (ℕ × ℕ) → TermMetric A)} {B = λ f → {csn₁ csn₂ : List (ℕ × ℕ)} → csn₁ ≤ᶜˢⁿ csn₂ → f csn₁ ≤ᴹ f csn₂}
              -- ( (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))) )
              -- ( λ csn bx → (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))) )
              -- (λ {X : Ty} (f : (List (ℕ × ℕ) → TermMetric X)) (bf : ({csn₁ csn₂ : List (ℕ × ℕ)} → csn₁ ≤ᶜˢⁿ csn₂ → f csn₁ ≤ᴹ f csn₂)) → (f , bf))
        ...
        -- W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')
        -- (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ))
        ...
        {-
          TP:
        GL:  ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))
        j0 : ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))
           ≡ ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))
        j1 : ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))
           ≡ ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ))
        GR:  ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ))
        -}

        -- h2 = dcong₂
        --       (λ x z → (x , z))
        --       {y₁ = f1}
        --       (refl {x = (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn))})
        --       (refl {x = f2})

              --{!!}
              {-
(λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ)))  c≤c'))))
subst (λ x → {csn₁ csn₂ : List (ℕ × ℕ)} (c≤c' : csn₁ ≤ᶜˢⁿ csn₂) → x csn₁ ≤ᴹ incr (suc ⟪ proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₁ csn₂ ⟫) (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ')) .proj₁ csn₂)) h0' c1)
-}

        -- g0 =   (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) ,
        --         (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) ,
        --         (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
        --      ≡ (ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) ,
        --        (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) ,
        --        f0)

        -- f1 = subst₂
        --       (λ x y →
        --          (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) ,
        --           (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) ,
        --           (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
        --         ≡
        --          (ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) ,
        ...
        --------------------------------------------------------------------
        {-
          (comp-mono-metric                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))
          (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))
        -}
...
h1-1      :                                                                                            ((λ z → incr (suc ⟪ proj₂ (comp-mono-metric W₂ E' ϖ') .proj₁ z ⟫)    (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z₁ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) z ⟫  + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) z ⟫ z))     , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) z))  , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')))  (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂  c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
l0-1: (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')))  (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂  c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
Goa1: (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
      ≡
Goa2: (ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ)) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ) (wkn-cong ϖ) (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) c≤c'))))
h1-2                                                                                                                               ≡ ((λ z → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z ⟫)   (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z ⟫   + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z ⟫ z))     , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) z))   , (λ {csn₁} {csn₂} → subst (λ f → {csn₁ = csn₃ : List (ℕ × ℕ)} {csn₂ = csn₄ : List (ℕ × ℕ)} → csn₃ ≤ᶜˢⁿ csn₄ → f csn₃ ≤ᴹ f csn₄) (trans (cong (λ r → proj₁ r) (cong (λ r → proj₂ r) a2)) h0') (λ {csn₁ = csn₃} {csn₂ = csn₄} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₃ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₃ ⟫ csn₃)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₄ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₄ ⟫ csn₄)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₃) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₄ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₄ ⟫ csn₄)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c')))))
l0-2: (ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ)) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn)) , e1)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                e1 = (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ)))  c≤c')))
-}
...
Goal: (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))
       , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn))
       , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
      ≡
      (ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ))
       , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn))
       , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ) (wkn-cong ϖ) (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) c≤c'))))

h1-1      :                                                                                             ((λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')))  (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c')))  wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
Goal-1:  (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric W₂ E' ϖ')) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
a2-1  :  (ccount W₁ (proj₁ (comp-mono-metric W₂ E' ϖ') ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ')) , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫) (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c'))) (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric W₂ E' ϖ') .proj₂ c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric W₂ E' ϖ') , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric W₂ E' ϖ')) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
       ≡
a2-2     (ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))                      , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c')))  (≤ᴹ-trans (comp-wkz-lemma                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c')) c≤c'))) wkz-id) csn₁)  (proj₂ (proj₂ (comp-mono-metric                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
Goal-2:  (ccount (wk-comp (wk-cong π) W₁) (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E) (wkc-cong (wkn-to-wkc ϖ))  , (λ csn → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫) (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) csn))   , (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong (s≤s (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c'))) (≤ᴹ-trans (comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁) (proj₂ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ)))  c≤c'))))
h1-2                                                                                                                                   ((λ z   → incr (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z ⟫)   (proj₁ (proj₂ (comp-mono-metric (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z   ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) z ⟫ z)) ,    (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E) (wkn-cong ϖ))) z))     , (λ {csn₁} {csn₂} c≤c' → subst₂ (λ x y → {csn₁ = csn₃ : List (ℕ × ℕ)} {csn₂ = csn₄ : List (ℕ × ℕ)} (c≤c'' : csn₃ ≤ᶜˢⁿ csn₄) → x csn₃ ≤ᴹ y csn₄) h0' h0' c1 c≤c'))

a2-2     (ccount W₁ (proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) ∷ elist-to-clist E') (wkc-cong (wkn-to-wkc ϖ'))                      ,
          (λ csn → incr
                    (suc ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫)
                    (proj₁ (proj₂ (comp-mono-metric W₁ ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn ⟫ csn)) , (λ c≤c' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) csn)) ,
          (λ {csn₁} {csn₂} c≤c' → ≤ᴹ-incr-cong
                    (s≤s (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c')))
                    (≤ᴹ-trans (comp-wkz-lemma W₁ ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c')) c≤c'))) wkz-id) csn₁)  (proj₂ (proj₂ (comp-mono-metric                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ'))) c≤c'))))
...
(comp-wkz-lemma                      W₁  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ z → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E') (wkn-cong ϖ') (wkn-cong ϖ') (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c'))  (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ) .proj₂ c≤c')) c≤c'))) wkz-id) csn₁)
(comp-wkz-lemma (wk-comp (wk-cong π) W₁) ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₁ ⟫ csn₁)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  ((`V , proj₁ (comp-mono-metric (wk-comp π W₂) E ϖ) , (λ _ → m-V 0 (⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ + csn-to-nat₀ ⟪ proj₁ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) csn₂ ⟫ csn₂)) , (λ c≤c'' → ≤-V z≤n ≤-refl)) ∷ E)  (wkn-cong ϖ) (wkn-cong ϖ)   (wkz-cong ≤-refl (λ csn → ≤-V z≤n (+-≤-cong (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) (≤ᶜˢⁿ-decr (≤ᴹ⇒≤ (proj₂ (proj₂ (comp-mono-metric (wk-comp π W₂) E ϖ)) c≤c')) c≤c'))) wkz-id) csn₁)
    -}
