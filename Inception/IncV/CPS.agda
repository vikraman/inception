module Inception.IncV.CPS (ℙ R : Set) where
...
mutual
  ...
  sub-comp-coh θ (inc M N) rewrite sub-comp-coh (sub-ex (sub-wk (wk-wk wk-id) θ) (var h)) M | sub-comp-coh (sub-ex (sub-wk (wk-wk wk-id) θ) (var h)) N = refl
